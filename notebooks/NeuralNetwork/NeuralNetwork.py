...
for epoch in range(num_epochs):
    ...
    train_actuals, train_predictions, train_probabilities, train_loss = evaluate_model(model, train_loader)
    ...
    val_actuals, val_predictions, val_probabilities, val_loss = evaluate_model(model, validation_loader)
...
test_actuals, test_predictions, test_probabilities, test_model_loss = evaluate_model(model, test_loader)

...
def load_data():
    ...
    below.
    """
    path = '/u/epw9kz/academic/first_year/ML/project/dataset/'
...
# training_data, validation_data, test_data = np.array(list(training_data)), np.array(list(validation_data)), np.array(list(test_data))
